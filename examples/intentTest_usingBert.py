...
from custom_modeling import BertForMultiLabelSequenceClassification
...
def main():
    ...
    parser.add_argument("--task_name",
                        default='intent_multilabel',
                        type=str,
                        required=True,
                        help="The name of the task to train.")
    parser.add_argument("--output_dir",
                        default='intent_output',
                        type=str,
                        required=True,
    ...
    def get_model():
        #pdb.set_trace()
        if model_state_dict:
            model = BertForMultiLabelSequenceClassification.from_pretrained(args.bert_model, cache_dir=cache_dir, num_labels = num_labels, state_dict=model_state_dict)
        else:
    ...
    if args.do_pred and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        model.eval()
        while True:
            print('enter a text to get intent. otherwise press Ctrl+C to close session.')
            text_a = input('>>>')
            #"Japan began the defence of their Asian Cup title with a lucky 2-1 win against Syria in a Group C championship match on Friday . ."
            eval_examples = {'text_a':text_a,'text_b':"The foodservice pie business does not fit our long-term growth strategy .",'labels':'1','guid':'12345'}
            ...
            for input_ids, input_mask, segment_ids, label_ids in tqdm(eval_dataloader, desc="Evaluating"):
                ...
                print("predictd : {}".format(logits_arr))
                print("actual : {}".format(label_ids))
                logits = logits.sigmoid()
                print("sigmoid : {}".format(logits))
                print("respective labels : {}".format(label_list))
